  ...
  <el-container>
    ...
    <el-main>
      <el-row class="wrapper">
        <el-col :span="8" >
          <div class="bg1"  @click="change('/anfang')">
            <img :src="small1" alt="">
            <p>安防平台</p>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="bg2"  @click="change('/portrayal')">
            <img :src="small2" alt="">
            <p>人员画像平台</p>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="bg3"  @click="change('/zongzhi')">
            <img :src="small3" alt="">
            <p>戒治综合平台</p>
          </div>
        </el-col>
      ...
      <el-row class="wrapper">
        <el-col :span="8">
          <div class="bg4"  @click="change('/data')">
            <img :src="small4" alt="">
            <p>大数据融合展示平台</p>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="bg5"  @click="change('/gis')">
            <img :src="small5" alt="">
            <p>GIS平台</p>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="bg6"  @click="change('/daily')">
            <img :src="small6" alt="">
            <p>日常办公平台</p>
          </div>
        </el-col>
